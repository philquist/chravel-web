...
describe('EventCard move mode actions', () => {
  beforeEach(() => {
  ...
  it('shows Move Trip in the overflow menu and calls the move handler', () => {
    ...
    render(<EventCard event={baseEvent} onMoveTrip={onMoveTrip} />);
  ...
  it('exits move mode instead of navigating when the View Event CTA is tapped', () => {
    ...
    render(<EventCard event={baseEvent} reorderMode onExitMoveMode={onExitMoveMode} />);
