      ...
      <div className="relative flex min-h-0 flex-1 flex-col">
        ...
        */}
        ...
        >
          <div
            aria-hidden="true"
            className="pointer-events-none flex min-h-0 flex-1 flex-col items-center justify-center px-4 pb-6 pt-[max(env(safe-area-inset-top),28px)]"
          >
            <span className="gold-gradient-text text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
              ChravelApp
            </span>
          </div>
          <div className="flex shrink-0 justify-center px-4 pb-[max(env(safe-area-inset-bottom),1rem)] pt-0">
